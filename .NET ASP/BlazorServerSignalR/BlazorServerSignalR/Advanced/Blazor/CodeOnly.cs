...
namespace BlazorServerSignalR.Advanced.Blazor
{
    ...
    {
        [Inject]
        public BlazorTDBContext? BlazorTDBContext { get; set; }
        public IEnumerable<string> Names => BlazorTDBContext?.Products.Select(p => p.ProductName) ?? Enumerable.Empty<string>();
