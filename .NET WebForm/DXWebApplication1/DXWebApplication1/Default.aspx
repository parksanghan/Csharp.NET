...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="True" DataSourceID="SqlDataSource1" KeyFieldName="CustomerID" ClientInstanceName="ASPxGridView1" Width="100%">
