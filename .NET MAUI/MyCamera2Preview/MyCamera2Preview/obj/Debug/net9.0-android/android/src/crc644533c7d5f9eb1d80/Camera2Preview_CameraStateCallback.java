...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MyCamera2Preview.Platforms.Android.Camera2Preview+CameraStateCallback, MyCamera2Preview", Camera2Preview_CameraStateCallback.class, __md_methods);
	}
	...
	public Camera2Preview_CameraStateCallback ()
	{
		...
		if (getClass () == Camera2Preview_CameraStateCallback.class) {
			mono.android.TypeManager.Activate ("MyCamera2Preview.Platforms.Android.Camera2Preview+CameraStateCallback, MyCamera2Preview", "", this, new java.lang.Object[] {  });
		}
	}

	public Camera2Preview_CameraStateCallback (crc644533c7d5f9eb1d80.Camera2Preview p0)
	{
		super ();
		if (getClass () == Camera2Preview_CameraStateCallback.class) {
			mono.android.TypeManager.Activate ("MyCamera2Preview.Platforms.Android.Camera2Preview+CameraStateCallback, MyCamera2Preview", "MyCamera2Preview.Platforms.Android.Camera2Preview, MyCamera2Preview", this, new java.lang.Object[] { p0 });
		}
	}
