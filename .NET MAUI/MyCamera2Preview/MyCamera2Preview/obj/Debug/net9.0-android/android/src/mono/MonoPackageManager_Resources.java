...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MyCamera2Preview.dll" comes first in this list. */
		"MyCamera2Preview.dll",
		"GoogleGson.dll",
		...
		"Xamarin.Google.MLKit.FaceDetection.dll",
		...
		"Xamarin.GooglePlayServices.MLKit.FaceDetection.dll",
