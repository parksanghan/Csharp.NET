...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Camera2View.Platforms.Android.Camera2Preview, Camera2View", Camera2Preview.class, __md_methods);
	}
	...
	public Camera2Preview (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		...
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("Camera2View.Platforms.Android.Camera2Preview, Camera2View", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2, p3 });
		}
	}
	...
	public Camera2Preview (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("Camera2View.Platforms.Android.Camera2Preview, Camera2View", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2 });
		}
	}
	...
	public Camera2Preview (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("Camera2View.Platforms.Android.Camera2Preview, Camera2View", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
		}
	}
	...
	public Camera2Preview (android.content.Context p0)
	{
		super (p0);
		if (getClass () == Camera2Preview.class) {
			mono.android.TypeManager.Activate ("Camera2View.Platforms.Android.Camera2Preview, Camera2View", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
