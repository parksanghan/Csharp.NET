	...
	//----자식 ID로 사용할 정보를 정의
	#define IDC_EDIT1		1 // 편집기 윈도우 컨트롤ID 
	#define IDC_STATIC1		2 // 텍스트 윈도우  컨트롤 ID

	HWND g_hedit1; // 편집기 핸들
	HWND g_static1; // 메시지 핸들  
	...
	LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
	{
		...
		case WM_CREATE:
		{
			...
			//에디트컨트롤의 프로시저를 변경!
			old = (WNDPROC)SetWindowLongPtr(g_hedit1, GWLP_WNDPROC, (LONG_PTR)foo);
			SetFocus(g_hedit1);
			return 0;
		}
